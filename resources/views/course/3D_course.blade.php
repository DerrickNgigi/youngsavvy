...
@section('content')
@section('title')
    3D Printing Course in Nairobi, Kenya
@endsection
@section('meta-data')
<meta property="og:type" content="website"/>
<meta property="og:site_name" content="Young Savy Engineering Center"/>
<meta property="og:title" content=" 3D Printing Course in Nairobi, Kenya"/>
<meta property="og:description" content="3D Printing Course in Nairobi Kenya that involves 3D printing classes involves introduction to 3D modeling, preparation of models for 3D printing and practical sessions."/>
<meta property="og:url" content="{{url('/learn-3d-printing-in-nairobi-kenya')}}"/>
<meta property="og:image" content="{{url('display/assets/favicon.png')}}"/>
<meta name="title" content="The Best 3D Printing Course in Nairobi, Kenya and East Africa"/>
<meta name="robots" content="index,follow"/>
<meta name="description" content="Explore and Understand 3D printing technology."/>
...
<link rel="canonical" href="{{url('/learn-3d-printing-in-nairobi-kenya')}}">
<link rel="shortlink" href="{{url('/learn-3d-printing-in-nairobi-kenya')}}" />
<link rel="next" href="{{url('/learn-3d-printing-in-nairobi-kenya')}}">
...
<script type="application/ld+json">
    {
      ...
      "description": "3D Printing Course in Nairobi Kenya that involves 3D printing classes involves introduction to 3D modeling, preparation of models for 3D printing and practical sessions.",
      "provider": {
    "@type": "Organization",
    "name": "Young Savvy Engineering Center",
    "sameAs": "{{url('/learn-3d-printing-in-nairobi-kenya')}}"
      }
    }
    </script>
@endsection
                                ...
                                <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                    <div class="content white-bg pt-30">
                                        ...
                                        <div class="course-overview">
                                            <div class="inner-box">
                                                <h4>3D Printing Course Details</h4>
                                                <p>3D printing is the future of modern fabrication that is cheap and fast for complex and custom designs and models.
                                                    3D printing classes involves introduction to 3D modeling, preparation of models for 3D printing and practical sessions.
                                                    3D printing knowledge enhances Prototyping skills and promotes Digital Literacy</p>
                                                <ul class="student-list">
{{--                                                    <li>115 - Total Students</li>--}}
...
{{--                                                    <li>256 Reviews</li>--}}
                                                ...
                                                <ul class="review-list">
                                                    <li>CAD Modelling.</li>
                                                    <li>Slicing Models.</li>
                                                    <li>Material Selection.</li>
                                                    <li>Pratical 3D Printing.</li>
                                                </ul>
{{--                                                <h3>Requirements</h3>--}}
{{--                                                <ul class="review-list">--}}
                    ...
                    <div class="video-column col-lg-4">
                        <div class="inner-column">
                            ...
                            <div class="intro-video media-icon orange-color2">
                                <img class="video-img" src="<?php echo url('/'); ?>/images/about/about-video-bg4.png" alt="Video Image">
                        ...
                        <div class="noticed">
                            <div class="main-part">
                                <div class="method-account">
                                    ...
                                    <form>
                                        <input class="form-control" type="text" placeholder="3D Printing Course" readonly>
