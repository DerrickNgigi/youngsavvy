...
@section('content')
@section('title')
    Computer Programming 101 Course in Nairobi, Kenya
@endsection
@section('meta-data')
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Young Savy Engineering Center" />
    <meta property="og:title" content=" Computer Programming 101 Course in Nairobi, Kenya" />
    ...
    <meta name="title" content="The Best Computer Programming 101 in Nairobi, Kenya and East Africa" />
    <meta name="robots" content="index,follow" />
    <meta name="description" content="Introduction to Programming and Game Design." />
    <meta name="keywords"
    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            ...
            <div class="breadcrumbs-text orange">
                <h1 class="page-title">Computer Programming 101</h1>
                <ul>
                    <li>
                                ...
                                <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                    <div class="content white-bg pt-30">
                                        ...
                                        <div class="course-overview">
                                            <div class="inner-box">
                                                <h4>Computer Programming 101</h4>
                                                <p>This is a programming course geared to promote acquisition of coding and game design to children 9-14 years .</p>
                    ...
                    <div class="video-column col-lg-4">
                        <div class="inner-column">
                            ...
                            <div class="intro-video media-icon orange-color2">
                                <img class="video-img" src="<?php echo url('/'); ?>/images/robotics-and-coding-coursess/8.jpg" alt="Video Image">
