...
@section('content')
@section('title')
    MicroWings Atmel Programming in Nairobi, Kenya
@endsection
@section('meta-data')
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Young Savy Engineering Center" />
    <meta property="og:title" content=" AVR Programming Course with Atmel in Nairobi, Kenya" />
    <meta property="og:description"
          content="This is a programming course geared to promote acquisition of coding and game design to children 9-14 years ." />
    <meta property="og:url" content="{{ url('/learn-introduction-to-programming-and-game-design-in-nairobi-kenya') }}" />
    <meta property="og:image" content="{{ url('display/assets/favicon.png') }}" />
    <meta name="title" content="The Best AVR Programming Course with Atmel in Nairobi, Kenya and East Africa" />
    <meta name="robots" content="index,follow" />
    <meta name="description" content="Introduction to AVR Programming with Atmel." />
    <meta name="keywords"
    ...
    <link rel="canonical" href="{{ url('/learn-introduction-to-programming-and-game-design-in-nairobi-kenya') }}">
    <link rel="shortlink" href="{{ url('/learn-introduction-to-programming-and-game-design-in-nairobi-kenya') }}" />
    <link rel="next" href="{{ url('/learn-introduction-to-programming-and-game-design-in-nairobi-kenya') }}">
...
@section('optimization')
    <script type="application/ld+json">
    {
      ...
      "description": "This is a programming course in Nairobi Kenya geared to promote acquisition of coding and game design to children 9-14 years.",
      "provider": {
    "@type": "Organization",
    "name": "Young Savvy Engineering Center",
    "sameAs": "{{url('/learn-introduction-to-programming-and-game-design-in-nairobi-kenya')}}"
      }
    }
    </script>
@endsection
...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text orange">
            <h1 class="page-title">MicroWings Atmel Programming</h1>
            <ul>
                <li>
                            ...
                            <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            <h4>MicroWings Atmel Programming</h4>
                                            <p>This is a programming course geared to help in Learning industrial Atmel Programming using the MicroWings Atmel Kit .</p>
                                            <ul class="student-list">
                                                {{--                                                    <li>156 - Total Students</li>--}}
                                            ...
                                            <ul class="review-list">
                                                <li>Introduction to ATMEL Studio.</li>
                                                <li>GPIO Ports and Registers in AVR ATmega32.</li>
                                                <li>Bit shifting.</li>
                                                <li>Analog to digital converter (ADC).</li>
                                                <li>USART in AVR ATmega32.</li>
                                                <li>Hardware interrupts.</li>
                                                <li>Interfacing 16x2 LCD with ATMEGA32.</li>
                                                <li>TIMERS and COUNTERS in ATMEGA32.</li>
                                                <li>PWM (analog output).</li>
                                                <li>Driving DC motors with AVR.</li>
                                                <li>SPI in AVRs.</li>
                ...
                <div class="video-column col-lg-4">
                    <div class="inner-column">
                        ...
                        <div class="intro-video media-icon orange-color2">
                            <img class="video-img" src="<?php echo url('/'); ?>/images/about/about4.png" alt="Video Image">
                        ...
                        <div class="course-features-info">
                            <ul>
                                ...
                                <li class="duration-feature">
                                    ...
                                    <span class="value">5 Classes </span>
                                </li>
                    ...
                    <div class="noticed">
                        <div class="main-part">
                            <div class="method-account">
                                ...
                                <form>
                                    <input class="form-control" type="text" placeholder="Computer Programming 101 Course" readonly>
