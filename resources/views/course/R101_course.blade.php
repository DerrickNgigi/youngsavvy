...
@section('content')
@section('title')
    Robotics 101 Course in Nairobi, Kenya.
@endsection
@section('meta-data')
...
<meta property="og:description" content="The students 13-17 years, are equipped with deep computer science concepts which gives sharpens their computational think capabilities. Students create and debug programs with specific goals."/>
<meta property="og:url" content="{{url('/learn-intermediate-Robotics-in-nairobi-kenya')}}"/>
<meta property="og:image" content="{{url('display/assets/favicon.png')}}"/>
<meta name="title" content="The Best Robotics 101 Course Courses in Nairobi, Kenya and East Africa"/>
<meta name="robots" content="index,follow"/>
<meta name="description" content="Intermediate Robotics and Coding 13-17 Years"/>
...
<link rel="canonical" href="{{url('/learn-intermediate-Robotics-in-nairobi-kenya')}}">
<link rel="shortlink" href="{{url('/learn-intermediate-Robotics-in-nairobi-kenya')}}" />
<link rel="next" href="{{url('/learn-intermediate-Robotics-in-nairobi-kenya')}}">
...
<script type="application/ld+json">
    {
      ...
      "description": "Intermediate Robotics Course in Nairobi Kenya that equipes students with deep computer science concepts which gives sharpens their computational think capabilities.",
      "provider": {
    "@type": "Organization",
    "name": "Young Savvy Engineering Center",
    "sameAs": "{{url('/learn-intermediate-Robotics-in-nairobi-kenya')}}"
      }
    }
    </script>
@endsection
    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            ...
            <div class="breadcrumbs-text orange">
                <h1 class="page-title">Robotics 101</h1>
                <ul>
                    <li>
                                ...
                                <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                    <div class="content white-bg pt-30">
                                        ...
                                        <div class="course-overview">
                                            <div class="inner-box">
                                                <h4>Robotics 101 Course Details</h4>
                                                <p>The students 13-17 years, are equipped with deep computer science concepts which gives sharpens their computational think capabilities.
                                                    Students create and debug programs with specific goals.</p>
                                                <ul class="student-list">
{{--                                                    <li>187 - Total Students</li>--}}
                                                ...
                                                <ul class="review-list">
                                                    ...
                                                    <li>Graphical/Block Programming.</li>
                                                    <li>Sensor and Actuators.</li>
                                                    <li>Group and Individual based projects.</li>
                                                    <li>Debugging.</li>
                                                </ul>
                                                {{--                                                <h3>Requirements</h3>--}}
                                                {{--                                                <ul class="review-list">--}}
                    ...
                    <div class="video-column col-lg-4">
                        <div class="inner-column">
                            ...
                            <div class="intro-video media-icon orange-color2">
                                <img class="video-img" src="<?php echo url('/'); ?>/images/courses/9.jpg" alt="Video Image">
                        ...
                        <div class="noticed">
                            <div class="main-part">
                                <div class="method-account">
                                    ...
                                    <form>
                                        <input class="form-control" type="text" placeholder="Robotics 101 Course" readonly>
