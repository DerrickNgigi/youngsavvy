...
@section('content')
@section('title')
    Beginner Robotics and Coding Course in Nairobi, Kenya
@endsection
@section('meta-data')
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Young Savy Engineering Center" />
    <meta property="og:title" content=" Beginner Robotics and Coding Course in Nairobi, Kenya" />
    <meta property="og:description"
        content="This is a beginner robotics and coding course geared to promote acquisition of early STEAM skills to children 9-12 years." />
    <meta property="og:url" content="{{ url('/learn-introduction-to-coding-and-Robotics-Age-(9-12)-in-nairobi-kenya') }}" />
    <meta property="og:image" content="{{ url('display/assets/favicon.png') }}" />
    <meta name="title" content="The Best Beginners Robotic and Coding (BRC) in Nairobi, Kenya and East Africa" />
    <meta name="robots" content="index,follow" />
    <meta name="description" content="Introducing to coding and Robotics (Age: 9-12 Years)" />
    <meta name="keywords"
    ...
    <link rel="canonical" href="{{ url('/learn-introduction-to-coding-and-Robotics-Age-(9-12)-in-nairobi-kenya') }}">
    <link rel="shortlink" href="{{ url('/learn-introduction-to-coding-and-Robotics-Age-(9-12)-in-nairobi-kenya') }}" />
    <link rel="next" href="{{ url('/learn-introduction-to-coding-and-Robotics-Age-(9-12)-in-nairobi-kenya') }}">
...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        <div class="breadcrumbs-img">
            <img src="<?php echo url('/'); ?>/images/breadcrumbs/1.jpeg"
                alt="Breadcrumbs Image">
        </div>
        <div class="breadcrumbs-text orange">
            <h1 class="page-title">Beginner Robotics and Coding</h1>
            <ul>
                <li>
                            ...
                            <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel"
                                ...
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            <h4>Beginner Robotics and Coding Course Details</h4>
                                            <p>This is a beginner robotics and coding course geared to promote
                                                acquisition of early STEAM skills to children 9-12 years .</p>
                                            <ul class="student-list">
                                                {{-- <li>204 - Total Students</li> --}}
                                                <li><span class="theme_color"></span> <span
                                            ...
                                            <ul class="review-list">
                                                <li>Robotics tools introduction and management.</li>
                                                <li>Building critical thinking, problem solving and computational
                                                    thinking.</li>
                                                <li>Investigating the principle of simple machines, mechanisms and
                                                    structures.</li>
                                                <li>Investigating models and designing real life solutions using
                                                    robotics tools.</li>
                                                <li>Understanding basic programming tools.</li>
                                            </ul>
                                            {{-- <h3>Requirements</h3> --}}
                                            {{-- <ul class="review-list"> --}}
                                                            ...
                                                            <div class="pull-left">
                                                                <a class="popup-videos play-icon"
                                                                    href="https://www.youtube.com/watch?v=atMUy_bPoQI"><i
                                                                        class="fa fa-play"></i>What is UI/ UX
                                                                    Design?</a>
                                                            </div>
                                            ...
                                            <div class="card-header" id="headingTwo">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link acc-btn collapsed"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseTwo">Color
                                                        Theory</button>
                                                </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingThree">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link acc-btn collapsed"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseThree">Basic
                                                        Typography</button>
                                                </h5>
                                            </div>
                                ...
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    ...
                                    <div class="row rs-team style1 orange-color transparent-bg clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 sm-mb-30">
                                            <div class="team-item">
                                                <img src="<?php echo url('/'); ?>/images/team/1.jpg"
                                                    alt="">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="team-item">
                                                <img src="<?php echo url('/'); ?>/images/team/2.jpg"
                                                    alt="">
                                                <div class="content-part">
                                                    <h4 class="name"><a href="#">Jhon Pedrocas</a></h4>
                                                    <span class="designation">Professor</span>
                                            ...
                                            <div class="card-header" id="headingEight">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link acc-btn collapsed"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseEight">Color
                                                        Theory</button>
                                                </h5>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingNine">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link acc-btn collapsed"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseNine">Basic
                                                        Typography</button>
                                                </h5>
                                            </div>
                ...
                <div class="video-column col-lg-4">
                    <div class="inner-column">
                        ...
                        <div class="intro-video media-icon orange-color2">
                            <img class="video-img"
                                src="<?php echo url('/'); ?>/images/courses/7.jpg"
                                alt="Video Image">
                        ...
                        <div class="course-features-info">
                            <ul>
                                ...
                                <li class="duration-feature">
                                    ...
                                    <span class="value">10 Classes </span>
                                </li>
                        ...
                        <div class="btn-part">
                            ...
                            <a href="#" class="btn readon2 orange-transparent" data-target="#apply-modal"
...
<!-- Modal Login-->
<div class="modal fade" id="apply-modal" tabindex="-1" role="dialog" aria-labelledby="ApplyModalLabel"
    aria-hidden="true">
                            ...
                            <div class="method-account">
                                ...
                                <form>
                                    <input class="form-control" type="text"
                                        placeholder="Beginner Robotics and Coding Course" readonly>
                                    ...
                                    <textarea class="from-control" id="message" name="message"
                                        placeholder=" Expectations about the Course" required="" rows="3"
                                        cols="38"></textarea>
